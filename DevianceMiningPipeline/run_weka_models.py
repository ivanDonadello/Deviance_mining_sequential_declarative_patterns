...
if __name__ == "__main__":
    if RUN == "python":
        ...
        try:
            ...
            jvm.start()
            train_over_Weka_RIPPER_old("data/experiments/sepsis_mr_tr_results/split1/declare/declare_train.csv", "data/experiments/sepsis_mr_tr_results/split1/declare/declare_test.csv")
